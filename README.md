# MonocularDepthEstimation - Deep Learning Challenge
...
The goal of this challenge is to develop a deep neural network to estimate depth
information from a single RGB image. The dataset provided includes images of a
virtual world generated using Unreal Engine with their corresponding depth maps,
the training set has 3469 samples while the validation set has 600 samples.
